...
<tr>
					...
					<tr>
						<th colspan="3"><div  style="width: 100%; background-color: grey; " >SUZUKI APV</div></th>	
					</tr>

					<tr>
						<td><div class="kosong" style="width: 10px; background-color: white"></div></td>
						<td><img width="240px" src="gambar/sewa rental mobil apv.jpg" style="background-size: 100%; "></td>
						
						<td><center>
							SUZUKI APV (M/T) 2009-2012 <br>
							<ins><strong>FASILITAS:</strong></ins><br>
							AC double blower, 7 sitter adult, MP3, CC:1500<br>
							<ins><strong>HARGA SEWA</strong></ins><br>
							1/2 hari: Rp. 275,000 <br>
							1 hari: Rp. 450,000 <br>
